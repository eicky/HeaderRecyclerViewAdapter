...
/**
 * @author Eicky
 * @Description: 上面标题，下面图片集合的recyclerview适配器
 * @date: 2016/12/28 15:23
 * @version: V1.0
 */
public abstract class HeaderRecyclerViewAdapter<H extends RecyclerView.ViewHolder, VH extends RecyclerView.ViewHolder> extends
